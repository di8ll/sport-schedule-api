...
const SportPage = () => {
 ...
 className={`py-3 sm:py-4 px-2 sm:px-3 text-[11px] sm:text-sm font-bold transition-all uppercase tracking-wider relative shrink-0 whitespace-nowrap border-b-2 -mb-[2px] flex items-center gap-1.5 ${
 isSelected
 ...
 <span className={`text-[9px] sm:text-[10px] font-extrabold tracking-widest uppercase px-2.5 sm:px-3 py-1 rounded-full border-2 text-center ${
 ...
 <span
 className={`text-sm sm:text-2xl font-mono font-black px-1 sm:px-2 py-0.5 rounded-xl border-2 ${
 ...
 <span
 className={`text-[8px] sm:text-[9px] font-extrabold tracking-widest mt-1 px-1.5 sm:px-2 py-0.5 rounded-full uppercase whitespace-nowrap ${
